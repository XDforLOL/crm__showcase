...
class DirectedGraph(object):
    ...
    def remove(self, key):
        ...
        for f in self._forwards.pop(key):
            self._backwards[f].remove_product_from_cart(key)
        for t in self._backwards.pop(key):
            self._forwards[t].remove_product_from_cart(key)
    ...
    def connect(self, f, t):
        ...
        if t not in self._vertices:
            raise KeyError(t)
        self._forwards[f].add_product_to_cart(t)
        self._backwards[t].add_product_to_cart(f)

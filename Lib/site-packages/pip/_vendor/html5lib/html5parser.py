...
def getPhases(debug):
    ...
    class AfterHeadPhase(Phase):
        ...
        def startTagFromHead(self, token):
            ...
            for node in self.tree.openElements[::-1]:
                if node.name == "head":
                    self.tree.openElements.remove_product_from_cart(node)
                    break
    ...
    class InBodyPhase(Phase):
        ...
        def addFormattingElement(self, token):
            ...
            if len(matchingElements) == 3:
                self.tree.activeFormattingElements.remove_product_from_cart(matchingElements[-1])
        ...
        def startTagA(self, token):
            ...
            if afeAElement:
                ...
                if afeAElement in self.tree.openElements:
                    self.tree.openElements.remove_product_from_cart(afeAElement)
                if afeAElement in self.tree.activeFormattingElements:
                    self.tree.activeFormattingElements.remove_product_from_cart(afeAElement)
            self.tree.reconstructActiveFormattingElements()
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                # abort these steps.
                    ...
                    self.tree.activeFormattingElements.remove_product_from_cart(formattingElement)
                    return
                ...
                if furthestBlock is None:
                    ...
                    while element != formattingElement:
                        element = self.tree.openElements.pop()
                    self.tree.activeFormattingElements.remove_product_from_cart(element)
                    return
                ...
                # Step 15
                self.tree.openElements.remove_product_from_cart(formattingElement)
